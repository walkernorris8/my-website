  ...
  return (
    <main className="bg-black text-white pt-24 min-h-screen">
      ...
      <section className="relative py-32 px-6 overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1920&q=80&fit=crop"
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden h-80">
            <Image
              src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&q=80&fit=crop"
              alt="Code on screen"
              fill
              className="object-cover"
            />
      ...
      <section className="relative h-64 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/75 flex items-center justify-center">
          <p className="text-2xl md:text-4xl font-extrabold text-center max-w-xl px-6">
            &ldquo;Your website should work as hard as <span className="text-blue-500">you do.</span>&rdquo;
          </p>
        </div>
      </section>
