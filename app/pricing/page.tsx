        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <FaqAccordion items={[
              ...
              { q: "What counts as a minor update?", a: "Text edits, image swaps, and small layout adjustments that can be completed within one hour. Additional pages, full redesigns, or third-party integrations are scoped and billed separately." },
